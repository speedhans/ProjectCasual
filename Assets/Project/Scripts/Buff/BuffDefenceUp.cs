...
public class BuffDefenceUp : Buff
{
    ...
    public BuffDefenceUp(Object _Self, string _BuffName, int _BuffID, float _LifeTime, float _AddDefence, E_DAMAGETYPE _Type, string _EffectPath, Character.E_ATTACHPOINT _Point) : 
