Shader "Custom/CustomFlantShader"
{
	Properties
	{
...
float2 Unity_GradientNoise_Dir_float(float2 p)
{
	...
	VertexDescription PopulateVertexData(VertexDescriptionInputs IN)
	{
		...
		Unity_Lerp_float3(IN.WorldSpacePosition, (_Combine_F661715B_RGBA_4.xyz), (_SampleTexture2DLOD_BBB0CEFD_R_5.xxx), _Lerp_598583DA_Out_3);
